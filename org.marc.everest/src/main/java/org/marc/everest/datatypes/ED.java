...
public class ED extends ANY implements IEncapsulatedData {
	...
	{
		this();
		this.m_representation = EncapsulatedDataRepresentation.Base64;
		this.setData(data);
	 ...
	 * @param language
	 */
	public ED(String data, String language) 
	{
		this(data);
	...
	public void setData(String value)
	{
		if(value == null)
			...
			this.m_data = value.getBytes(Charset.forName("UTF8"));
	}
	/**
	 ...
	 */
	@Property(name = "thumbnail", conformance = ConformanceType.REQUIRED, propertyType = PropertyType.NONSTRUCTURAL)
