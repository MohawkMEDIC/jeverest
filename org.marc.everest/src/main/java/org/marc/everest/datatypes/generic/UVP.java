...
import org.marc.everest.datatypes.interfaces.IProbability;
...
public class UVP<T extends IAny> extends ANY implements IProbability<T> {
	 ...
	 */
	@Property(name = "value", propertyType = PropertyType.NONSTRUCTURAL, conformance = ConformanceType.MANDATORY)
	@Override
	public T getValue() {
		return this.m_value;
	}
	...
	public String toString() {
		return this.getValue() == null || this.getProbability() == null ? super.toString() : String.format("~%s (%.2f %%)", this.getValue(), this.getProbability() * 100.0);
	}
	@Override
	public int hashCode() {
		final int prime = 31;
