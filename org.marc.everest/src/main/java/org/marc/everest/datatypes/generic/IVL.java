...
import org.marc.everest.datatypes.interfaces.IInterval;
...
public class IVL<T extends IAny> extends SXCM<T> implements IInterval<T>, IPqTranslatable<IVL<T>>, IOriginalText  {
	 ...
	 * @param high The initial value of the upper bound of the interval
	 */
	public IVL(T low, Boolean lowInclusive, T high, Boolean highInclusive) { this(low, high); this.m_lowInclusive = lowInclusive; this.m_highInclusive = highInclusive; }
	/**
	 ...
	 * @param operator The manner in which this IVL instance participates in a containing SET expression
	 */
	public IVL(T low, Boolean lowInclusive, T high, Boolean highInclusive, SetOperator operator) { this(low, lowInclusive, high, highInclusive); this.setOperator(operator); }
