...
import org.marc.everest.datatypes.interfaces.ITelecommunicationsAddress;
 ...
 */
@Structure(name = "TEL", structureType = StructureType.DATATYPE)
public class TEL extends PDV<String> implements ITelecommunicationsAddress {
    ...
    /**
     * Determines if this instance of TEL semantically equals the other instance of TEL
     */
	@Override
	public BL semanticEquals(IAny other) {
		// TODO Auto-generated method stub
		BL retVal = super.semanticEquals(other);
		if(!retVal.toBoolean())
			return retVal;
		return new BL(this.getValue().equals(((TEL)other).getValue()));
