...
public class ST extends PDV<String> {
	 ...
	 */
	@Flavor(name = "ST.NT")
	public static Boolean isValidNoTranslationsFlavor(ST st)
	{
	...
	public static Boolean isValidSimpleFlavor(ST st)
	{
        ...
        if (st.getLanguage() != null && st.getLanguage().equals(defaultLanguage))
            st.setLanguage(null);
	...
	/**
	 * @see org.marc.everest.datatypes.generic.PDV#validateEx()
	 */
	@Override
	public Collection<IResultDetail> validateEx() {
         ...
         if(this.isNull() && this.getValue() != null && !this.getValue().isEmpty())
