...
import org.marc.everest.datatypes.interfaces.ISemanticEquals;
...
public class SET<T extends IGraphable> extends COLL<T> implements Set<T>, ISet<T> {
	 ...
	 */
	public static final Comparator<IGraphable> defaultComparator = new Comparator<IGraphable>() {
		 ...
		 */
		@Override
		public int compare(IGraphable a, IGraphable b) {
	...
	// Backing set
	private List<T> m_set = new ArrayList<T>();
	// Backing comparator
	private Comparator<IGraphable> m_comparator = SET.defaultComparator;
	
	/**
	 * Gets the comparator that is currently being used by this instance of
	 * SET to determie duplicate entries
	 */
	public Comparator<IGraphable> getComparator() { return this.m_comparator; }
	/**
	 * Sets a custom comparator for determining if duplicate entries have been
	 * entered into this type
	 */
	public void setComparator(Comparator<IGraphable> value) { this.m_comparator = value; }
	 ...
	 */
	public SET(Comparator<IGraphable> comparator)
	{
		this();
	...
	public SET(Iterable<? extends IGraphable> collection, Comparator<IGraphable> comparator)
	{
		this();
		this.m_comparator = comparator == null ? SET.defaultComparator : comparator;
		if(collection == null)
			return;
