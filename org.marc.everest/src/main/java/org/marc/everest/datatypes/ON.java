...
import org.marc.everest.datatypes.generic.Predicate;
...
public class ON extends EN {
	...
	/**
	 * Creates a new instance of the ON type with the specified uses and parts
	 */
	public ON(SET<CS<EntityNameUse>> use, List<ENXP> parts) { super(use, parts); }
	/**
	...
	/**
	 * @see org.marc.everest.datatypes.EN#validateEx()
	 */
	@Override
	...
	public boolean validate() {
        ...
        if(this.getParts() != null)
        	for(ENXP part : this.getParts())
        		for (EntityNamePartType t : disallowedPartTypes)
        			isValid &= part.getType() == null || !part.getType().getCode().equals(t);
