...
public class FixedValueMisMatchedResultDetail extends ValidationResultDetail {
	...
	{
		super(ResultDetailType.ERROR, String.format("The supplied value of '%s' doesn't match the fixed value of '%s'", suppliedValue, fixedValue), location, null);
	...
	{
		super(ResultDetailType.WARNING, String.format("The supplied value of '%s' doesn't match the fixed value of '%s'. %s",  suppliedValue, fixedValue, wasOverwritten ? "The supplied value has been used in place of the fixed" : "The supplied value was ignored"), location, null);
