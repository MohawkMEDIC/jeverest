...
public class DatatypeValidationResultDetail extends ValidationResultDetail {
	...
	public String getMessage() {
		if(super.getMessage() == null || super.getMessage().equals(""))
			return String.format("Data type '%s' failed basic validation, please refer to the developer's guide for more detail", this.m_datatypeName);
		else
			return String.format("Data type '%s' failed basic validation. The violation was : %s", this.m_datatypeName, super.getMessage());
	}
