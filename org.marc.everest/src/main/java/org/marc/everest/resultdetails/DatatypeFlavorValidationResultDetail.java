...
public class DatatypeFlavorValidationResultDetail extends DatatypeValidationResultDetail {
	...
	public String getMessage() {
		return String.format("Datatype '%s' failed validation criteria for flavor '%s'. Please refer to development guide for more information", this.getDatatypeName(), this.m_flavorName);
	}
